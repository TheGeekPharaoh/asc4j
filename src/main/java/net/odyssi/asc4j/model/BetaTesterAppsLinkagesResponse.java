...
public class BetaTesterAppsLinkagesResponse implements Serializable {
	...
	private static final long serialVersionUID = 7166984238026092737L;
	...
	public BetaTesterAppsLinkagesResponse addDataItem(AppClipRelationshipsAppData dataItem) {
		this.data.add(dataItem);
		return this;
	}

	public BetaTesterAppsLinkagesResponse data(List<AppClipRelationshipsAppData> data) {
		this.data = data;
		return this;
	}
