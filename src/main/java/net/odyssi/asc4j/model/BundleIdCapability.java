...
public class BundleIdCapability implements Serializable {

	public enum TypeEnum {

		BUNDLEIDCAPABILITIES(String.valueOf("bundleIdCapabilities"));
	...
	private static final long serialVersionUID = -222984821876929207L;
