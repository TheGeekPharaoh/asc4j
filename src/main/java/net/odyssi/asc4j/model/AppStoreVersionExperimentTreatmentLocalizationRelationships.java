...
public class AppStoreVersionExperimentTreatmentLocalizationRelationships implements Serializable {

	private static final long serialVersionUID = 5373100093827373381L;
	...
	public AppStoreVersionExperimentTreatmentLocalizationRelationships appPreviewSets(
			AppCustomProductPageLocalizationRelationshipsAppPreviewSets appPreviewSets) {
		this.appPreviewSets = appPreviewSets;
		return this;
	}

	public AppStoreVersionExperimentTreatmentLocalizationRelationships appScreenshotSets(
			AppCustomProductPageLocalizationRelationshipsAppScreenshotSets appScreenshotSets) {
		this.appScreenshotSets = appScreenshotSets;
		return this;
	}

	public AppStoreVersionExperimentTreatmentLocalizationRelationships appStoreVersionExperimentTreatment(
			AppStoreVersionExperimentTreatmentLocalizationRelationshipsAppStoreVersionExperimentTreatment appStoreVersionExperimentTreatment) {
