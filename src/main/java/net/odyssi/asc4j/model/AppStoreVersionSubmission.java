...
public class AppStoreVersionSubmission implements Serializable {

	public enum TypeEnum {

		APPSTOREVERSIONSUBMISSIONS(String.valueOf("appStoreVersionSubmissions"));
	...
	private static final long serialVersionUID = -948001949912709763L;
