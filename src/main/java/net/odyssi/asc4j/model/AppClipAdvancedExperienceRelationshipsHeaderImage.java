...
public class AppClipAdvancedExperienceRelationshipsHeaderImage implements Serializable {

	private static final long serialVersionUID = 1732223413841105260L;
	...
	public AppClipAdvancedExperienceRelationshipsHeaderImage data(
	...
	public AppClipAdvancedExperienceRelationshipsHeaderImage links(AppCategoryRelationshipsSubcategoriesLinks links) {
		this.links = links;
		return this;
	}
	...
	public String toString() {
		...
		sb.append("class AppClipAdvancedExperienceRelationshipsHeaderImage {\n");
