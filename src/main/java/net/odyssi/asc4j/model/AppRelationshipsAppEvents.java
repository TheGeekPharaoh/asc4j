...
public class AppRelationshipsAppEvents implements Serializable {

	private static final long serialVersionUID = 8721118969208218100L;
	...
	private List<AppEventLocalizationRelationshipsAppEventData> data = null;
	...
	public AppRelationshipsAppEvents links(AppCategoryRelationshipsSubcategoriesLinks links) {
		this.links = links;
		return this;
	}
