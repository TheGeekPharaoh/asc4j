...
public interface AppPricesApi {

	/**
	 * Read App Price Information
	 *
	 * Read current price and scheduled price changes for an app, including price
	 * tier and start date.
	 *
	 */
	@GET
	...
	public Response readAppPriceInformation(@PathParam("id") String id,
